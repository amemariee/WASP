...
class ConnectionProvider: NSObject, WCSessionDelegate {
    ...
    var receviedPrograms : [ProgramObject] = []
    ...
    func initFakeDetails(){
        ...
        progObj.initWithData(title: "CST 123", speaker: "String", from: "String", to: "String", details: ".")
        programs.append(progObj)
        
        let progObj2 = ProgramObject()
        progObj2.initWithData(title: "CST 153", speaker: "String", from: "String", to: "String", details: ".")
    ...
    func session(_ session: WCSession, didReceiveMessage message: [String : Any]) {
        ...
        if(message["progData"] != nil){
            ...
            self.receviedPrograms = loadedPerson!
